...
TABLE_PROPERTY_PATTERNS: dict[str, str] = {
    ...
    'total_nitrogen': r'total\s+(?:N\b|nitrogen)|\bN[_ ]?total\b|общ\w*\s+азот|\bNобщ\b',
    ...
    'total_phosphorus': r'total\s+(?:P\b|phosphorus)|общ\w*\s+фосфор',
    'available_phosphorus': r'available\s+(?:P\b|phosphorus)|mobile\s+phosphorus|P[₂2]O[₅5]|подвижн\w*\s+фосфор',
    'total_potassium': r'total\s+(?:K\b|potassium)|общ\w*\s+кали',
    'available_potassium': r'available\s+(?:K\b|potassium)|mobile\s+potassium|K[₂2]O|подвижн\w*\s+кали',
    ...
    'potassium_exchangeable': r'exchangeable\s+(?:K\b|potassium)|обменн\w*\s+кали',
    'sodium': r'exchangeable\s+(?:Na\b|sodium)|обменн\w*\s+натри',
    'aluminium_exchangeable': r'exchangeable\s+(?:Al\b|aluminium|aluminum)|обменн\w*\s+алюмин',
    ...
    'microbial_biomass_carbon': r'microbial\s+biomass\s+(?:C\b|carbon)|\bMBC\b|микробн\w*\s+биомасс\w*\s+углерод',
    'microbial_biomass_nitrogen': r'microbial\s+biomass\s+(?:N\b|nitrogen)|\bMBN\b|микробн\w*\s+биомасс\w*\s+азот',
    ...
    'exchangeable_calcium': r'exchangeable\s+(?:Ca\b|calcium)|обменн\w*\s+(?:Ca\b|кальци)',
    'exchangeable_magnesium': r'exchangeable\s+(?:Mg\b|magnesium)|обменн\w*\s+(?:Mg\b|магни)',
