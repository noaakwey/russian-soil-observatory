...
const STRINGS = {
  ru: {
    ...
    'overview.report': 'Полный научный анализ базы: состав корпуса, качество извлечения, пространственная и временная структура →',
  ...
  en: {
    ...
    'overview.report': 'Full scientific audit: corpus composition, extraction quality, spatial and temporal structure →',
